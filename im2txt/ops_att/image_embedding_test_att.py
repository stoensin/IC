...
class InceptionV4Test(tf.test.TestCase):

    def setUp(self):
        super(InceptionV4Test, self).setUp()
    ...
    def _countInceptionParameters(self):
        ...
        for v in tf.global_variables():
            ...
            if name_tokens[0] == "InceptionV4":
                name = "InceptionV4/" + name_tokens[1]
    ...
    def _verifyParameterCounts(self):
        ...
        expected_param_counts = {
            "InceptionV4/Conv2d_1a_3x3": 960,
            "InceptionV4/Conv2d_2a_3x3": 9312,
            "InceptionV4/Conv2d_2b_3x3": 18624,
            "InceptionV4/Conv2d_3b_1x1": 5360,
            "InceptionV4/Conv2d_4a_3x3": 138816,
            "InceptionV4/Mixed_5b": 256368,
            "InceptionV4/Mixed_5c": 277968,
            "InceptionV4/Mixed_5d": 285648,
            "InceptionV4/Mixed_6a": 1153920,
            "InceptionV4/Mixed_6b": 1298944,
            "InceptionV4/Mixed_6c": 1692736,
            "InceptionV4/Mixed_6d": 1692736,
            "InceptionV4/Mixed_6e": 2143872,
            "InceptionV4/Mixed_7a": 1699584,
            "InceptionV4/Mixed_7b": 5047872,
            "InceptionV4/Mixed_7c": 6080064,
        }
    ...
    def testTrainableTrueIsTrainingTrue(self):
        embeddings = image_embedding.inception_v4(
